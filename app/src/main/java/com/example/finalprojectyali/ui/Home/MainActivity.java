    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_donate:
                ...
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://m.youtube.com/watch?v=UICsbQIKi9s&pp=ygUQ16TXqNeh15XXnteqIGJpdNIHCQmNCQGHKiGM7w%3D%3D"));
            ...
            case R.id.nav_auth:
                ...
                break;
            case R.id.nav_join_by_code:
                Log.i("MoveScreen", "MoveToJoinByCodeScreen:Success");
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
                builder.setTitle("ENTER 4-ALPHANUMERIC CODE");

                final EditText input = new EditText(this);
                // Force the keyboard to show uppercase letters
                ...
                input.setFilters(new InputFilter[]{lengthFilter, alphanumericFilter});
                builder.setView(input);

                builder.setPositiveButton("SUBMIT", (dialog, which) -> {
                    String code = input.getText().toString().toUpperCase();
                    if (code.length() == 4 && code.chars().allMatch(Character::isLetterOrDigit)) {
                        GroupRepository.joinByCode(code,
                                g -> {
                                    Toast.makeText(this, "JOINED " + g.getName().toUpperCase(), Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(MainActivity.this, "CODE MUST BE EXACTLY 4 ALPHANUMERIC CHARACTERS", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public static void getUserDetails(FirebaseCallback callback) {
        ...
        task.addOnSuccessListener(dataSnapshot -> {
            ...
            if (user_fb == null) {
                ...
                current_user.setPhoneNumber("050-000-0000");
            } else {
